...
public class HotelFoodController {
   ...
   /* @PostMapping(value = "/addhotelfood")
    ...
    public FoodEntity addFood(@RequestBody String parameters)
       ...
       // HotelFoodEntity hotelFoodEntity = mapper.readValue(parameters, HotelFoodEntity.class);
        
        

        try {
            int result = hotelFoodService.addHotelFood(hotelFoodEntity,foodEntity);
            if (result == 0)//500
             {
    ...
    public ResponseEntity<?> addHotelFood(@RequestBody String parameter)
        ...
        // logger.debug("POST:CustomerController:addCustomer::parameters::
        // "+parameters);
        /*String str1=objectNode.get("str1").asText();
        String str2=objectNode.get("str2").asText();*/
